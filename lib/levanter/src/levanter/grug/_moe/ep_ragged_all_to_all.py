...
# Select the device-initiated ragged all-to-all kernel and register all-gather buffers so
# NCCL can use copy engines when the communicator selects its ZERO CTA policy.
